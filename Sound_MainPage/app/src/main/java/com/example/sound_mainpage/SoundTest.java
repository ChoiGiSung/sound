...
public class SoundTest extends AppCompatActivity {
    ...
    public void sountTest(){
        ...
        for(int j=0;j<10;j++){
            ...
            final int choice=j;//플레이어의 답 담기위한 변수
            //좌 우 소리 발생
            switch (ran){
                case 0:
            ...
            btn_left.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    playResult[choice]="l";//플레이어의 답 담기
                    Toast.makeText(getApplicationContext(),"왼쪽"+Integer.toString(choice+1)+"/"+"10",Toast.LENGTH_SHORT).show();
                    if(playResult[9] !=null) {
                        result_sound(result, playResult);
                    }
                }
            });
            btn_right.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    playResult[choice]="r";
                    Toast.makeText(getApplicationContext(),"오른쪽"+Integer.toString(choice+1)+"/"+"10",Toast.LENGTH_SHORT).show();
                    if(playResult[9] !=null) {
                        result_sound(result, playResult);
                    }
                }
    ...
    //채점하기
    public void result_sound(String[] result,String[] player){
        int answer=0;
        for(int i=0;i<10;i++){
